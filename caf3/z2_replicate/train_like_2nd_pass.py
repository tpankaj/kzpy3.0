...
def main():
	weights_file_path = most_recent_file_in_folder(opjD('z2_replicate'),['z2_replicate','caffemodel']) 
	...
	while True:
		if True:#try:
			load_bag_folders(bair_car_data,num_to_load=25)
...
unix('mkdir -p '+opjD('z2_replicate'))
