        ...
        while not rospy.is_shutdown():
            try:        
                ...
                if signal == Arduino.STATE_GPS:
                    # lat, long (floats)
                    print d2s("here 1 ", data[2])
                    assert(len(data) == 15)
                    print d2s("here 1 ", data[3])
                    self.GPS2_hour_pub.publish(std_msgs.msg.Int32(data[1]))
                    """
                    self.GPS2_min_pub.publish(std_msgs.msg.Int32(data[2]))
                    self.GPS2_sec_pub.publish(std_msgs.msg.Int32(data[3]))
                    self.GPS2_day_pub.publish(std_msgs.msg.Int32(data[4]))
                    self.GPS2_mon_pub.publish(std_msgs.msg.Int32(data[5]))
                    self.GPS2_yr_pub.publish(std_msgs.msg.Int32(data[6]))
                    self.GPS2_fix_pub.publish(std_msgs.msg.Int32(data[7]))
                    self.GPS2_qual_pub.publish(std_msgs.msg.Int32(data[8]))
                    self.GPS2_lat_pub.publish(std_msgs.msg.Float32(data[9]))
                    self.GPS2_long_pub.publish(std_msgs.msg.Float32(data[10]))
                    self.GPS2_speed_pub.publish(std_msgs.msg.Float32(data[11]))
                    self.GPS2_angle_pub.publish(std_msgs.msg.Float32(data[12]))
                    self.GPS2_alt_pub.publish(std_msgs.msg.Float32(data[13]))
                    self.GPS2_sat_pub.publish(std_msgs.msg.Int32(data[14]))
