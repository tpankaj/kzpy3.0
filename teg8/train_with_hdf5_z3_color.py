...
if True:
	...
	solver_name = opjh('kzpy3/caf7/z3_color/solver.prototxt')
	#solver_name = opjh('kzpy3/caf7/z2_color/solver_state_1_5_6_7.prototxt')
	solver = setup_solver(solver_name)
	weights_file_path = opjh('Desktop/z3_color/z3_color_iter_800000.caffemodel')
	solver.net.copy_from(weights_file_path)
	cprint('Loaded weights from '+weights_file_path)
	N_FRAMES = 4 # how many timesteps with images.
	...
	while True:
		...
		if print_timer.check():
			print(solver.net.blobs['metadata'].data[0,:,0,0])
			...
			mi_or_cv2_animate(data['left'],delay=30)
			print_timer.reset()
