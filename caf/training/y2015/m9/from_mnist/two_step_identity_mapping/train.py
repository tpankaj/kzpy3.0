...
Take the MNIST number, randomly reverse contrast and present this to net. Output is
classification and identity mapping of original number without any contrast reversal.
...
from kzpy3.caf.training.y2015.m9.from_mnist.two_step_identity_mapping.train import *
setup_solver()
train()

or

from kzpy3.caf.training.y2015.m9.from_mnist.two_step_identity_mapping.train import *;setup_solver();train(1000)
...
net = caffe.Net(opjh('kzpy3/caf/training/y2015/m9/from_mnist/two_step_identity_mapping/deploy.prototxt'),opjh('scratch/2015/9/20/caffe/models/from_mnist/two_step_identity_mapping/model_iter_10000.caffemodel'),caffe.TEST)
...
def setup_solver():
	global solver
	solver = caffe.SGDSolver(opjh("kzpy3/caf/training/y2015/m9/from_mnist/two_step_identity_mapping/solver.prototxt"))
...
def restore(itr):
	solver.restore(opjh(d2n('scratch/2015/9/20/caffe/models/from_mnist/two_step_identity_mapping/model_iter_',itr,'.solverstate')))


def deploy(itr):
	global net
	net = caffe.Net(opjh('kzpy3/caf/training/y2015/m9/from_mnist/two_step_identity_mapping/deploy.prototxt'),opjh(d2n('scratch/2015/9/20/caffe/models/from_mnist/two_step_identity_mapping/model_iter_',itr,'.caffemodel')),caffe.TEST)
