...
20 Sept. 2015
Do this:
from kzpy3.caf.training.y2015.m9.from_mnist.reshape_ip2.train import *
...
def setup_solver():
	global solver
	solver = caffe.SGDSolver(opjh("kzpy3/caf/training/y2015/m9/from_mnist/reshape_ip2/solver.prototxt"))
...
def restore():
	solver.restore(opjh('scratch/2015/9/20/caffe/models/from_mnist/reshape_ip2/model_iter_5000.solverstate'))


def deploy(img_name = opjh('caffe/examples/images/7.jpg')):
	global net
	net = caffe.Net(opjh('kzpy3/caf/training/y2015/m9/from_mnist/reshape_ip2/deploy.prototxt'),opjh('scratch/2015/9/20/caffe/models/from_mnist/reshape_ip2/model_iter_5000.caffemodel'),caffe.TEST)
