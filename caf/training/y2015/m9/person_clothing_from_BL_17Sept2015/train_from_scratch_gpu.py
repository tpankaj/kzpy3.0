...
cms = gg(opjh('caffe/models/person_clothing_from_BL_17Sept2015/*.caffemodel'))
ctimes = []
for c in cms:
...
caffe.set_device(0)
caffe.set_mode_gpu()
solver = caffe.SGDSolver(opjh('caffe/models/person_clothing_from_BL_17Sept2015/solver.prototxt'))
