from kzpy3.caf.kaffe.utils_2 import *
...
img_name = 'cat.jpg'
img = imread(opjh('Desktop/np.jpg')) #'caffe/examples/images',img_name))#'Desktop/np.jpg')) #'Desktop/np.jpg')) #
img = img[:,:,:3]
