...
class NetHolder(object):
    ...
    def __init__(self, model_name, input_img):
        ...
        if False:
            self.activations['inception_3a/1x1'][0,15,3,3]= 1.0 
...
img_name = 'cat.jpg'
img = imread(opjh('Desktop/wo.jpg')) #'caffe/examples/images',img_name))#'Desktop/np.jpg')) #'Desktop/np.jpg')) #'Desktop/np.jpg')) #
img = img[:,:,:3]
'''
