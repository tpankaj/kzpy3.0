...
def make_step(net, step_size=1.5, end='inception_4c/output', 
    ...
    a=0.2
    src.data[:,0,:,:] = (1.0-a) * src.data[:,0,:,:] + a * mona[:,:,0] * (1-mask)*z2o_g_abs_sum#gray
    src.data[:,1,:,:] = (1.0-a) * src.data[:,1,:,:] + a * mona[:,:,0] * (1-mask)*z2o_g_abs_sum#gray
    src.data[:,2:,:] = (1.0-a) * src.data[:,2,:,:] + a * mona[:,:,0] * (1-mask)*z2o_g_abs_sum#gray
    """
        ...
        for i in range(iter_n):
            ...
            if True:
                if np.mod(i,20)==0:
                    ...
                    imsave(opj(img_path,str(n)+'.mod.'+str((x_center,y_center))+'.png'),(mona[:,:,0]* (1-mask)-mona[:,:,0].mean())*z2o(g_abs_sum)+mona[:,:,0].mean())
...
if True:
    ...
    start_node = 49#423#267#55#55#528
