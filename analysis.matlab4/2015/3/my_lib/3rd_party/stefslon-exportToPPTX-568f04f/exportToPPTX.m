...
PPTXInfo.CONST.DEFAULT_DIMENSIONS  = [16 9];     % in inches
...
if ischar(inputText),
    paraText    = {inputText}; %regexp(inputText,'\n','split'); % KZ 23 Oct 2014
else
    paraText    = inputText;
end
...
% KZ, 22 Oct. 2014, don't want '-' to indicate list.        
%         if paraText{ipara}(1)=='-',
...
%         end
        ...
        [fmtStart,fmtStop,tokStr,splitStr] = regexpi(paraText{ipara},'','start','end','tokens','split');
