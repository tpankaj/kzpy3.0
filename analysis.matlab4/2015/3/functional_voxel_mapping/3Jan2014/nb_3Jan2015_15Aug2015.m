...
if 0 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if not(exist('stimVal512_uint8'))
         load('~/Desktop/fMRI_top_node/data.fMRI/experiment-Kay_2008/stimuli-stimVal/version-512px/stimVal512_uint8.mat');
    end
...
if 0 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    voxel_set = v1_high_snr;%high_snr;%union(v1_high_snr,v2_high_snr);
    voxel_set_name = 'v1_high_snr';
end
