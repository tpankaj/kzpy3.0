        ...
        for j = 1:100
            ...
            if and(j==100,GRAPHICS)
                ...
                for i = 1:N
                    ...
                    display_matrix(xy(1),xy(2),1) = z_score;%S.stim(VAL).data(voxels(i),randVal);
                    %if ctr > S.roi(voxels(i))
                        display_matrix(xy(1),xy(2),2) = 1+S.roi(voxels(i));%1+S.roi(voxels(i));
                    %end
                    %end
                end
                ...
                mi(display_matrix(a:b,a:b,1),1,[1,2,1],d2s({ctr-1}));
