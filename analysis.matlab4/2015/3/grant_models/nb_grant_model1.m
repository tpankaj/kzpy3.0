...
CELL_NUM = 20;
    ...
    t = (1:1000)/1000;
    tn = t.^(1/4);
    tn100 = round(1000*tn(1:10:1000));
    
    g = gaussian(1:1000,500,125);
    g2 = gaussian(1:100,30,20.5);
    g3 = gaussian(1:200,90,15);
    gn100 = g(tn100)-g2/17;
    gn100(40:99)=gn100(1:60);
    gn100(1:40)=0;
...
%     sf(50:100) = 1; sf(250:300) = 1;
    ...
    mp({thresh_s_gn100(1:500),'b-'},2,[2,2,3]);
    hold on; mp({thresh_s_gn100(1:500)+thresh_s_gn100(1:500).*thresh_s_g3(1:500),'r-'},2,[2,2,3]); hold off;
	%mp({,'o-'},2,[2,2,4]);
