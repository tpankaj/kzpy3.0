...
if 0 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    resampled_data = attend_scene_BarryLyndon_16Jan2015_3_resampled_data;%attend_person_not_BL_BarryLyndon_16Jan2015_3_resampled_data;%fixate_BarryLyndon_16Jan2015_3_resampled_data;%
    frames = BL_frames_3;
