% from Vermeer_reading_11Feb2015.m
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Make a surface/attention video based on the  Vermeer attending and reading experiment.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
video_name = 'surface_attention_13June2015';
...
for p = 1:12
    v(p,:,:,:) = imread(d2s({'~/Desktop/Artists/Nakayama/' p '.png'}));
end
for i = 1:5*6
    mi( blank_fix);
...
for the_block = 1:8
    for p = 1:6
        for i = 1:6*5
            ...
            img2 = display_image;%place_img_A_in_img_B(mini_text,display_image,0,0);
