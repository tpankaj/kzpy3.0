...
for the_block = 1:8
    for p = 1:6
        for i = 1:6*5
            ...
            img2_blank = place_img_A_in_img_B(mini_text,blank_fix,0,0);
            %display_image(190:194,254:258,:)=0;
            img2 = display_image;
            mi( img2);
            for ff = 1:1
                writeVideo(outputVideo,img2);
                %writeVideo(outputVideo,img2_blank);
            end
            pause(1/500);
