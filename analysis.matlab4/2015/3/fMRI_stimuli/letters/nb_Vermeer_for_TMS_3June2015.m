...
if 1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    WRITE_VIDEO = true;
    if WRITE_VIDEO
        video_name = 'Titian_TMS_3June2015';
    ...
    fixspot_TRs = textread('/Users/davidzipser/Google_Drive/Data/stimuli/2015/4/9April2015_TMS_jittered_design/fixspot.txt');
    picture_TRs = textread('/Users/davidzipser/Google_Drive/Data/stimuli/2015/4/9April2015_TMS_jittered_design/picture.txt');
    TMS_level_TRs = textread('/Users/davidzipser/Google_Drive/Data/stimuli/2015/4/9April2015_TMS_jittered_design/TMS_level.txt');
    ...
    for p = 1:3
        img = imread(d2s({'/Users/davidzipser/Google_Drive/Data/stimuli/2015/6/Titian/' p '.jpg'}));
        img = single(img);
    ...
    for tr = 1:length(fixspot_TRs)%1:160 %
        tr
        fx = fixspot_TRs(tr);
        pc = picture_TRs(tr);
        tm = TMS_level_TRs(tr);
