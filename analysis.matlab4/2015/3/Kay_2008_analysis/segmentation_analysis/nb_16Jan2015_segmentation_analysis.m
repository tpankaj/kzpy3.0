...
CELL_NUM = 10;
    ...
    if not(exist('S3_Pimages_15Oct2014'))
        fprintf('loading S3_Pimages_15Oct2014.735977.3819.mat\n');
        load('~/Desktop/fMRI_top_node/data.fMRI/experiment-Kay_2008/after_January_2015/S3_Pimages_15Oct2014.735977.3819.mat');
    end
    ...
    if not(exist('stimTrn512_segmentations_human_shirts_modified2_int8'))
        load('~/Desktop/fMRI_top_node/data.fMRI/experiment-Kay_2008/stimuli-stimTrn/segmentations/stimTrn512_segmentations_human_heads_modified2_int8.735980.257.mat');
        load('~/Desktop/fMRI_top_node/data.fMRI/experiment-Kay_2008/stimuli-stimTrn/segmentations/stimTrn512_segmentations_human_shirts_modified2_int8.735980.257.mat');
    end
    if not(exist('stimTrn512_segmentations_animal_torsos_modified2_int8'))
        load('~/Desktop/fMRI_top_node/data.fMRI/experiment-Kay_2008/stimuli-stimTrn/segmentations/stimTrn512_segmentations_animal_heads_modified2_int8.735980.2582.mat');
        load('~/Desktop/fMRI_top_node/data.fMRI/experiment-Kay_2008/stimuli-stimTrn/segmentations/stimTrn512_segmentations_animal_torsos_modified2_int8.735980.2582.mat');
    end
