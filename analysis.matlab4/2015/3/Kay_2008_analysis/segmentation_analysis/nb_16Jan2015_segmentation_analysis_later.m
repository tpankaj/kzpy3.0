...
CELL_NUM = 10;
    ...
    essential_data = {...
        {'S1_Pimages_15Oct2014',[G.Desktop kay '/after_January_2015/S1_Pimages_15Oct2014.735977.3739.mat']},...
        {'S2_Pimages_15Oct2014',[G.Desktop kay '/after_January_2015/S2_Pimages_15Oct2014.735977.3775.mat']},...
        {'S3_Pimages_15Oct2014',[G.Desktop kay '/after_January_2015/S3_Pimages_15Oct2014.735977.3819.mat']},...
        {'stimTrn512_segmentations_animal_heads_int8',[G.Desktop kay '/stimuli-stimTrn/segmentations/stimTrn512_segmentations_animal_heads_int8.735979.5968.mat']},...
        {'stimTrn512_segmentations_animal_torsos_int8',[G.Desktop kay '/stimuli-stimTrn/segmentations/stimTrn512_segmentations_animal_torsos_int8.735979.5969.mat']},...
        {'stimTrn512_segmentations_human_heads_int8',[G.Desktop kay '/stimuli-stimTrn/segmentations/stimTrn512_segmentations_human_heads_int8.735977.2433.mat']},...
        {'stimTrn512_segmentations_human_shirts_int8',[G.Desktop kay '/stimuli-stimTrn/segmentations/stimTrn512_segmentations_human_shirts_int8.735977.2434.mat']},...
        {'stimTrn512_segmentations_human_shirts_modified2_int8',[G.Desktop kay '/stimuli-stimTrn/segmentations/stimTrn512_segmentations_human_heads_modified2_int8.735980.257.mat']},...
        {'stimTrn512_segmentations_human_shirts_modified2_int8',[G.Desktop kay '/stimuli-stimTrn/segmentations/stimTrn512_segmentations_human_shirts_modified2_int8.735980.257.mat']},...
        {'stimTrn512_segmentations_animal_torsos_modified2_int8',[G.Desktop kay '/stimuli-stimTrn/segmentations/stimTrn512_segmentations_animal_heads_modified2_int8.735980.2582.mat']},...
        {'stimTrn512_segmentations_animal_torsos_modified2_int8',[G.Desktop kay '/stimuli-stimTrn/segmentations/stimTrn512_segmentations_animal_torsos_modified2_int8.735980.2582.mat']},...   
        {'stimTrn512_segmentations_extended_texture_regions_int8',[G.Desktop kay '/stimuli-stimTrn/segmentations/stimTrn512_segmentations_extended_texture_regions_int8.735979.4325.mat']},...    
        {'stimTrn512_segs_extended_texture_regions_without_edges_int8',[G.Desktop kay '/stimuli-stimTrn/segmentations/stimTrn512_segs_extended_texture_regions_without_edges_int8.735979.5032.mat']},...
        };
    ...
    for seg = [1 6 7 8 9]
        for subj = 1:3
            if true%seg < 8
                ...
                a=segmentation_results.s(subj).roi(V1).data_version(1).segmentation(seg).mean_vals(more_textured_animal_bodies_V1);
                b=segmentation_results.s(subj).roi(V1).data_version(3).segmentation(seg).mean_vals(more_textured_animal_bodies_V1);
                m1 = [mean(a) mean(b)];
                se1 = [std(a)/sqrt(length(a)) std(b)/sqrt(length(b))];
                a=segmentation_results.s(subj).roi(V2).data_version(1).segmentation(seg).mean_vals(more_textured_animal_bodies_V2);
                b=segmentation_results.s(subj).roi(V2).data_version(3).segmentation(seg).mean_vals(more_textured_animal_bodies_V2);
                m2 = [mean(a) mean(b)];
                se2 = [std(a)/sqrt(length(a)) std(b)/sqrt(length(b))];
            end
            ...
            fsp(seg,[1,3,subj]);barwitherr(ses, ms);
...
% bins = -4:0.25:4;
% for v=1:3
%     fsp(1,[1 3 v]);mean_vals=segmentation_results.s(1).roi(V1V2).data_version(v).segmentation(1).mean_vals;hist(mean_vals,bins);title(mean(mean_vals));
% end
% end
% 
