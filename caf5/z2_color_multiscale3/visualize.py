...
weights_file_path = opjD('z2_color_multiscale/z2_color_multiscale.caffemodel') #
#
########################################################
...
solver = setup_solver()
weights_file_path = opjD('z2_color_multiscale')
weights_file_path = most_recent_file_in_folder(weights_file_path,['z2_color_multiscale','caffemodel'])
