...
if True:
	solver = setup_solver(opjh('kzpy3/caf7/squeezenet/solver.prototxt'))
        solver.restore('/home/bdd/Desktop/squeezenet/squeezenet_iter_19500000.solverstate')
	...
	while True:
		...
		solver.net.blobs['metadata'].data[0,6,:,:] = 0.0
		solver.net.blobs['metadata'].data[0,7,:,:] = 0.0
		solver.net.blobs['metadata'].data[0,8,:,:] = 0.0
		solver.net.blobs['metadata'].data[0,9,:,:] = 0.0
		solver.net.blobs['metadata'].data[0,10,:,:] = 0.0
		solver.net.blobs['metadata'].data[0,11,:,:] = 0.0
