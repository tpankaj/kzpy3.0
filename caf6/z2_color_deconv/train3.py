...
##############################################################################
#
model_path = opjh("kzpy3/caf6/z2_color_deconv")
version = 'version 1b'
gpu = 1
base_lr = 0.000001
snapshot = 100000
...
test_runs_folder = '/media/karlzipser/ExtraDrive1/test_runs' #opjD('hdf5','test_runs')
...
train_val_lst = [
	...
	conv("conv1",'ZED_data_pool2',96,1,11,3,[0,0],"gaussian",std='0.00001'),
	relu("conv1"),
	pool("conv1","MAX",3,2,0),
	drop('conv1_pool',0.0),

	#concat('conv1_metadata_concat',["conv1_pool","metadata"],1),
	conv("conv2",'conv1_pool',256,2,3,2,0,"gaussian",std='0.1'),relu("conv2"),

	deconv("deconv2",'conv2',256,1,8,4,[0,1],'gaussian',std='0.1'),relu("deconv2"),
	deconv("deconv3",'deconv2',96,1,9,3,0,'gaussian',std='0.1'),relu("deconv3"),
	conv("conv1_",'deconv3',96,1,11,3,0,"gaussian",std='0.1'),relu("conv1_"),pool("conv1_","MAX",3,2,0),
	conv("conv2_",'conv1__pool',256,2,3,2,0,"gaussian",std='0.1'),relu("conv2_"),pool("conv2_","MAX",3,2,0),
	ip("ip1","conv2__pool",512,"xavier",std=0),
	relu('ip1'),
	drop('ip1',0.0),
