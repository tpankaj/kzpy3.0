...
#######################################
#
model_path = opjh("kzpy3/caf6/z2_color_streamline")
version = 'version 1b'
gpu = 1
base_lr = 0.001
snapshot = 10000
...
train_val_lst = [
	...
	conv_layer_set("conv1",'ZED_data_pool2',4*96,1,11,3,0,"MAX",3,2,0,"gaussian",std='0.00001'),
	concat('conv1_metadata_concat',["conv1_pool","metadata"],1),
	conv_layer_set("conv2",'conv1_metadata_concat',4*256,2,3,2,0,"MAX",3,2,0,"gaussian",std=0.1),
