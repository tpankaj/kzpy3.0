...
class Arduino:
    ...
    def __init__(self, baudrate=115200, timeout=0.25):
        ...
        self.cmd_signal_sub = rospy.Subscriber('signal', std_msgs.msg.Int32,
        ...
        threading.Thread(target=self._ros_signal_thread).start()
    ...
    def _ros_signal_thread(self):
        ...
        while not rospy.is_shutdown():
            if True:#try:        
                ...
                for var, queue in (('signals', self.cmd_signal_queue)):
                    if not queue.empty():
