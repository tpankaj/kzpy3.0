...
# Two kinds of complications. OsX and ubuntu have different ways of 
# specifying serial port. And, on ubuntu, the ACM1 can depend on both
# the order of the USBs in the connectors and the order in which they
# are plugged in. Thus, it would be good to have some error checking.
