                    ...
                    if apply_rectangles:
                        if side == 'left':
                            ...
                            try:
                                ...
                                apply_rect_to_img(img,gymag,0,60,[0,150,255],[0,0,0],0.7,0.03,center=False)
                            except:
                                print t
...
def apply_rect_to_img(img,value,min_val,max_val,pos_color,neg_color,rel_bar_height,rel_bar_thickness,center=False,reverse=True):
    h,w,d = shape(img)
